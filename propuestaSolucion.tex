...
A continuación, en la figura \ref{fig:arquitectura} se presenta un diagrama de arquitectura hecho como parte de la documentación del sistema, que ilustra la interacción entre los diferentes componentes y servicios involucrados en la solución propuesta.

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{img/img_2430124/arquitectura.jpg}
