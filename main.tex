...
\newcommand{\NombreAlumno}{Angel Gabriel Coronado Sánchez}
\soulregister{\NombreAlumno}{1}
% NUNCA PONGAN EL TITULO EN MAYUSCULAS!!
\newcommand{\NombreProyecto}{Desarrollo e implementación de un sistema cotizador en línea a través de inteligencia artificial } 
% Noten los \\ para insertar un ENTER del texto en el encabezado. NUNCA PONGAN EL TITULO EN MAYUSCULAS!!
\newcommand{\NombreProyectoheader}{Desarrollo e implementación de un sistema cotizador \\en línea a través de inteligencia artificial}
\newcommand{\NombreTSU}{Desarrollo de Software Multiplataforma}
\newcommand{\UnidadEconomica}{TIKS y Capacitaciones S. DE R.L.}
\newcommand{\nasesorempresaria}   {Dr. Mario Humberto Rodriguez Chávez}
\newcommand{\nasesorinstitucional}{Dr. Said Polanco Martagón}
\newcommand{\Matricula}           {2430124}  %SU MATRICULA
...
Se presentó el proyecto titulado "\NombreProyecto", desarrollado en la unidad económica \UnidadEconomica, ubicada en Emma Vázquez García 2314, Fraccionamiento La Cima, Ciudad Victoria, Tamaulipas.\\
El objetivo fue desarrollar e implementar un sistema cotizador en línea utilizando inteligencia artificial y un panel administrativo para la gestión de productos, con el fin de optimizar el proceso de cotización y facilitar la administración de productos.\\
El proyecto se desarrolló utilizando tecnologías como Laravel para la creación del backend, React para las interfaces de usuario, PostgreSQL como gestor de bases de datos, Redis para mejorar el rendimiento de consultas de base de datos y la API de OpenAI como motor de inteligencia artificial.\\
Como resultado, se implementó un sistema de cotizaciones automarizado que prevé dar servicio mediante WhatsApp y un wdget embebible en la página web de la empresa. Asimismo, se entregó un panel administrativo que permite a los administradores gestionar productos, categorias, ver estadisticas de cotizaciones y los detalles de las consultas realizadas por los clientes, entre otras funcionalidades.\\
Se concluye que la solución ofreció una alternativa eficiente para agilizar la atención al cliente y optimizar la gestión interna de la empresa.
...
The project titled “Development and implementation of an online quote system using artificial intelligence”, developed at the business unit TIKS and Workshops LLC, located at Emma Vázquez García 2314, Fraccionamiento La Cima, Ciudad Victoria, Tamaulipas, was presented.\\
The objective was to develop and implement an online quoting system using artificial intelligence and an administrative dashboard for product management, in order to optimize the quoting process and facilitate product administration.\\
The project was developed using technologies such as Laravel for the backend, React for the user interfaces, PostgreSQL as the database management system, Redis to improve database query performance, and the OpenAI API as the artificial Intelligence engine.\\
As a result, an automated quoting system was implemented that is designed to provide service via WhatsApp and an embeddable widget on the company’s website. In addition, an administrative dashboard was delivered that allows administrators to manage products and categories, view quote statistics, and review the details of customer requests, among other features.\\
It was concluded that the solution provided an efficient alternative for improving customer service and optimizing the company’s internal management.
...
\begin{sidewaystable}
\centering
\large {\textbf{Rúbrica para la Evaluación del Reporte de Estadía}}\par\vspace{0.5cm}
